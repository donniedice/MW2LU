...
-- Chat Message
		...
		Event_Frame_C:SetScript("OnEvent",
		    ...
		    if event == "ADDON_LOADED" then
					print("|cff4f4f4fMW2LU - Modern Warfare 2 Level Up!|r Will no longer be receiving updates. Functionality has been merged into |c2d4b92ffBLU - Better Level Up!|r. If you're a fan of my sound addons, |c2d4b92ffBLU - Better Level Up!|r is available from all addon provider websites. Thank you!")
				end
	end)
